...
**轻量级的正确理解**: 轻量级意味着较短上下文与较低迭代预算，仍由 architecture、technical、feasibility 三个 Custom Agent 独立执行并聚合 ≥90% 共识。它不跳过 delphi-review，也不减少专家数。见 references/force-levels.md。
